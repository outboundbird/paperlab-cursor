...
- **Remaining work:** A2 — full implement/run orchestration smoke + production-flow re-validation via `/experimenter` from a fresh chat. See [`log/2026-06-17-gibgat-extension-regime-revalidation.md`](./log/2026-06-17-gibgat-extension-regime-revalidation.md) § Open follow-ups #1.
