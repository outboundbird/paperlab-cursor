...
- `coder` → `.cursor/skills/ml-experiment-code/SKILL.md` (**Stage-1 section shipped 2026-06-04**; Stage-2 section is a placeholder until Stage 2 is built)
